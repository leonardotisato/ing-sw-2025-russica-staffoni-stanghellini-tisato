...
class LoadCrewActionTest {
    ...
    void checkAction() {
        ...
        assertFalse(loadCrewAction.checkAction(p1));
        ...
        assertFalse(loadCrewAction.checkAction(p3));
        ...
        brownAlienCoords = new Coordinates(1,2);
        loadCrewAction = new LoadCrewAction("Charlie", pinkAlienCoords, brownAlienCoords);
        assertFalse(loadCrewAction.checkAction(p3)); // todo for some reason pink passes the test...

        // both correct
        pinkAlienCoords = new Coordinates(3, 4);
        brownAlienCoords = new Coordinates(1,2);
        loadCrewAction = new LoadCrewAction("Charlie", pinkAlienCoords, brownAlienCoords);
        assertTrue(loadCrewAction.checkAction(p3));
